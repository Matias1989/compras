...
?>
	...
	<script>
		var input = document.getElementById('nro_comprobante');
		if (input.oninvalid == TRUE){
			function(event){
    		event.target.setCustomValidity('Valor Inválido');
			}
		}	
	</script>	
	</HEAD>
			...
			<form method="POST" action="#" id="form-datos" onsubmit="return validar()">
				...
				<table align="center">
					...
					<tr>
						...
						($comprobante) ? $comprobante['nro_comprobante']:'');?>" placeholder="N° Comprobante" required pattern="[0-9]{15}"></td>
					</tr>
					<tr>
