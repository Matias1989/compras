			...
			<form method="POST" action="altaproveedor2.php" id="form-datos" onsubmit="return validar()">
				...
				<table align="center">
					<tr>
						...
						($proveedor) ? $proveedor['nombre_proveedor']:'';?>" placeholder="Nombre" required pattern="[A-Za-z-\t-A-Za-z]{5,50}"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" name="cuit" id="cuit" value="<?=
					...
					<tr>
						...
						($proveedor) ? $proveedor['email']:'';?>" placeholder="Email" required/></td>
					</tr>
					<tr>
						<td colspan="2" align="center" class=""></td>
					</tr>
